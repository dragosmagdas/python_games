...
#platforms
platform1 = Rect((450, 500), (100, 10)) #platform middle of the screen
...
# pygame.mixer.quit()
# pygame.mixer.pre_init(22050, -16, 2, 1024)
sounds.ninja_music.play(-1) #play in a loop

def draw():
    global platform61, platform62

    screen.fill((173, 216, blue))
    screen.blit('castle3', (0, 0))
...
def ninja_move():
    global ninja_x_velocity, ninja_y_velocity, jumping, gravity, jumped, allow_x, timer, points, d_xy
    ...
    #stop going outside the screen on X
